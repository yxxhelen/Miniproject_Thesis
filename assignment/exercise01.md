...
Connect the photoresistor using the 10k ohm resistor as a voltage divider
...
These values will change with room illumination and the specific photoresistor you have.
